...
type ComplexityRoot struct {
	Mutation struct {
		Create func(childComplexity int, input model.In) int
	}
	...
	Out struct {
		Textout func(childComplexity int) int
	}
}

type MutationResolver interface {
	Create(ctx context.Context, input model.In) (*model.Out, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.create":
		...
		return e.complexity.Mutation.Create(childComplexity, args["input"].(model.In)), true

	case "out.textout":
		if e.complexity.Out.Textout == nil {
			break
		}

		return e.complexity.Out.Textout(childComplexity), true
...
func (ec *executionContext) field_Mutation_create_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNin2githubᚗcomᚋsayanicbnitsᚋPersonalProjectᚋsendmailᚋgraphᚋmodelᚐIn(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_create(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().Create(rctx, args["input"].(model.In))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.(*model.Out)
	fc.Result = res
	return ec.marshalNout2ᚖgithubᚗcomᚋsayanicbnitsᚋPersonalProjectᚋsendmailᚋgraphᚋmodelᚐOut(ctx, field.Selections, res)
}
...
func (ec *executionContext) _out_textout(ctx context.Context, field graphql.CollectedField, obj *model.Out) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) unmarshalInputin(ctx context.Context, obj interface{}) (model.In, error) {
	var it model.In
...
var outImplementors = []string{"out"}

func (ec *executionContext) _out(ctx context.Context, sel ast.SelectionSet, obj *model.Out) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, outImplementors)
	out := graphql.NewFieldSet(fields)
	var invalids uint32
	for i, field := range fields {
		switch field.Name {
		case "__typename":
			out.Values[i] = graphql.MarshalString("out")
		case "textout":
			innerFunc := func(ctx context.Context) (res graphql.Marshaler) {
				return ec._out_textout(ctx, field, obj)
			}
...
func (ec *executionContext) unmarshalNin2githubᚗcomᚋsayanicbnitsᚋPersonalProjectᚋsendmailᚋgraphᚋmodelᚐIn(ctx context.Context, v interface{}) (model.In, error) {
	res, err := ec.unmarshalInputin(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNout2githubᚗcomᚋsayanicbnitsᚋPersonalProjectᚋsendmailᚋgraphᚋmodelᚐOut(ctx context.Context, sel ast.SelectionSet, v model.Out) graphql.Marshaler {
	return ec._out(ctx, sel, &v)
}

func (ec *executionContext) marshalNout2ᚖgithubᚗcomᚋsayanicbnitsᚋPersonalProjectᚋsendmailᚋgraphᚋmodelᚐOut(ctx context.Context, sel ast.SelectionSet, v *model.Out) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
